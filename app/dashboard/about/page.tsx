    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400">
          Production-grade Agentic AI Stock Market Prediction System
        </p>
      </div>
      ...
      <div className="card">
        ...
        <p className="text-gray-300 leading-relaxed mb-4">
          TradeFlux is a cutting-edge stock market prediction system that
          leverages multi-agent AI architecture, Prophet forecasting, and
          real-time sentiment analysis to provide accurate market predictions
          and actionable insights.
        </p>
        <p className="text-gray-300 leading-relaxed">
          Built with Next.js 14, Python, PostgreSQL, and powered by CrewAI,
          Prophet, and OpenAI LLM, this system represents the future of
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>• OpenAI LLM (Primary), Groq (Fallback)</li>
            </ul>
          </div>
          <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { name: "NewsFetcherAgent", desc: "Fetches news from News API" },
            {
              ...
              desc: "Sentiment analysis with VADER",
            },
            {
              name: "MarketDataAgent",
              desc: "Historical OHLCV from Yahoo Finance",
            },
            ...
            { name: "PredictionAgent", desc: "Prophet-based forecasting" },
            {
              ...
              desc: "Human insights via OpenAI or Groq",
            },
          ...
          {[
            {
              ...
              desc: "Prophet forecasting with confidence intervals",
            },
            {
              icon: <Brain />,
              title: "Sentiment Analysis",
              desc: "Real-time news sentiment using VADER + LLM",
            },
            {
              icon: <Database />,
              title: "Historical Data",
              desc: "Comprehensive market data with technical indicators",
            },
            {
              icon: <Zap />,
              title: "Real-time Updates",
              desc: "Live market data and agent execution",
            },
            {
              icon: <Code />,
              title: "Production Ready",
              desc: "Clean architecture with TypeScript and Python",
            },
            {
              icon: <Shield />,
              title: "Reliable",
              desc: "Error handling and logging throughout",
            },
          ].map((feature, idx) => (
