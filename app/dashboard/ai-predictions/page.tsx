...
import { Play, Loader, RefreshCw, Download, FileDown, FileJson } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-400">Prophet-based forecasting with LLM insights</p>
                </div>
            ...
            <div className="card">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-400 mb-2">Forecast Days</label>
                        <input
                            type="number"
                            value={days}
                ...
                {message && (
                    <p className={`mt-3 text-sm ${messageIsError ? 'text-red-400' : 'text-primary'}`}>
                        {message}
                    </p>
                )}
            </div>
            ...
            {latestPrediction && (
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="card">
                        ...
                        <div className="text-2xl font-bold text-primary">${latestPrediction.predictedPrice.toFixed(2)}</div>
                    </div>
                    <div className="card">
                        <div className="text-sm text-gray-400 mb-1">Confidence</div>
                        <div className="text-2xl font-bold text-green-400">{(latestPrediction.confidence * 100).toFixed(0)}%</div>
                    </div>
                    <div className="card">
                        <div className="text-sm text-gray-400 mb-1">Range</div>
                        <div className="text-2xl font-bold">${latestPrediction.lowerBound.toFixed(2)} – ${latestPrediction.upperBound.toFixed(2)}</div>
                    </div>
                </div>
            )}
            ...
            {predictions.length > 0 && (
                <div className="card">
                    <h3 className="text-xl font-bold mb-4">Recent Predictions ({predictions.length})</h3>
