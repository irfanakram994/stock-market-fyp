            ...
            try:
                ...
                if not market.get("success"):
                    ...
                    result = create_response(True, data={
                        ...
                        "forecast": predictions.get("data", {}).get("forecast", predictions.get("data", {}).get("predictions", [])),
                        "historical": predictions.get("data", {}).get("historical", []),
                        "components": predictions.get("data", {}).get("components", {}),
                        "modelMetrics": predictions.get("data", {}).get("modelMetrics", {}),
